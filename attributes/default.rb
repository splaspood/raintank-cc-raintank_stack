...
default[:raintank_stack][:versions][:metric] = "0.1.0"
default[:raintank_stack][:versions][:graphite_api] = "1.0.1"
...
# collector
default[:raintank_stack][:collector_app] = "/opt/raintank-collector"
